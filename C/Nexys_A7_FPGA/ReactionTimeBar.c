    ...
    while (1)
    {
        ...
        if (init_code == 0)
        {
            ...
            if(Xms > 8000){
                ...
                writeValtoLEDs(0x7FFF);
            }
            else if (Xms > 7000){
                writeValtoLEDs(0x3FFF);
            }
            else if (Xms > 6500){
                writeValtoLEDs(0x1FFF);
            }
            else if (Xms > 6000){
                writeValtoLEDs(0x0FFF);
            }
            else if (Xms > 5500){
                writeValtoLEDs(0x07FF);
            }
            else if (Xms > 5000){
                writeValtoLEDs(0x03FF);
            }
            else if (Xms > 4500){
                writeValtoLEDs(0x01FF);
            }
            else if (Xms > 4000){
                writeValtoLEDs(0x00FF);
            }
            else if (Xms > 3500){
                writeValtoLEDs(0x007F);
            }
            else if (Xms > 3000){
                writeValtoLEDs(0x003F);
            }
            else if (Xms > 2500){
                writeValtoLEDs(0x001F);
            }
            else if (Xms > 2000){
                writeValtoLEDs(0x000F);
            }
            else if (Xms > 1500){
                writeValtoLEDs(0x0007);
            }
            else if (Xms > 1000){
